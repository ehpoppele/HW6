...
TEST_CASE("Forests! Forests should be a collection of trees that we can manipulate. Trees themselves are not tested here.")
{
    ...
    */
    ...
    //Forest 1
    HForest::tree_vec forest_collection_1{tree_1, tree_2, tree_3, tree_4};
    HForest test_forest_1(forest_collection_1);
    //Forest 2
    HForest::tree_vec forest_collection_2{tree_3, tree_4, tree_5};
    HForest test_forest_2(forest_collection_2);
